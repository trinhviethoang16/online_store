...
namespace ProjectOnlineStore.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(IEmailSender sender, ILogger<AppUser> logger, IUserStore<AppUser> userStore, UserManager<AppUser> userManager, AppDbContext appDbContext, SignInManager<AppUser> signInManager)
        {
            _sender = sender;
            _logger = logger;
