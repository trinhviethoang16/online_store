...
namespace ProjectOnlineStore.Controllers
{
    public class CategoryAdminController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Image,Title,Alias")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Image,Title,Alias")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
